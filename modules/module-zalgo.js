...
exports.getHelp = function() { return {
  '*': '`zalgo <text...>` - add zalgo chars to text. add !u, !um, !umd for up/middle/down'
}};

exports.listener = function(line, words, respond) {
  respond(zalgo('normal', 'umd', words.slice(1).join(' ')));

};


// totally not from http://www.eeemo.net/
